...
def get_train_test_args():
    ...
    parser.add_argument('--outer_batch-size', type=int, default=4)
    parser.add_argument('--outer_lr', type=float, default=3e-5)
    parser.add_argument('--n_task', type=float, default=5)
    parser.add_argument('--k_way', type=float, default=16)
    parser.add_argument('--sample_p', type=float, default=0.001)
