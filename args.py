...
def get_train_test_args():
    ...
    parser.add_argument('--ideal_batch_size', type=int, default = 16)
    ...
    parser.add_argument('--oodomain', default = True)
    ...
    parser.add_argument('--outer_num_epochs', type=int, default=3)
    parser.add_argument('--outer_lr', type=float, default=3e-4)
    parser.add_argument('--n_task', type=float, default=2)
    parser.add_argument('--k_shot', type=float, default=8)
